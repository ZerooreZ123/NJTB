...
const Bar = {
  ...
  methods: {
    ...
    updateChart: function () {
      var barData = [];
      barData.push(this.vehicleproduce.SumQuantity)
      barData.push(this.vehicleproduce.SumSend)
      barData.push(this.vehicleproduce.SumSend > this.vehicleproduce.SumQuantity ? 0 : this.vehicleproduce.SumQuantity - this.vehicleproduce.SumSend)
      const option = {
        series: [{
          data: barData
        }]
